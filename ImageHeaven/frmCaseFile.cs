    ...
    public partial class frmCaseFile : Form
    {
        ...
        public bool validate()
        {
            ...
            if (!System.Text.RegularExpressions.Regex.IsMatch(deTextBox4.Text, "[^0-9]"))
            {
                    ...
                    if(validate() == true)
                    {
                        if (listView1.Items.Count > 0)
                        {
                            for (int i = 0; i < listView1.Items.Count; i++)
                            {
                                ...
                                {
                                    MessageBox.Show("This File/Case already exists...", "B'Zer - Calcutta High Court", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                                    deTextBox5.Focus();
                                    return;
                                }
                                else
                ...
                {
                    MessageBox.Show("You have to fill all these fields", "B'Zer - Calcutta High Court", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    deTextBox1.Focus();
                    deTextBox1.Select();
                    return;
                }
            ...
            {
                MessageBox.Show("Case Year isn't a number...", "B'Zer - Calcutta High Court", MessageBoxButtons.OK, MessageBoxIcon.Error);
                deTextBox4.Focus();
                deTextBox4.Select();
                return;
            }
                ...
                if (deTextBox1.Text != "" && deTextBox2.Text != "" && deTextBox5.Text != "" && deTextBox3.Text != "" && deTextBox4.Text != "")
                {
                    if (validate() == true)
                    {
                        if (listView1.Items.Count > 0)
                        {
                            ...
                            {
                                MessageBox.Show("You have to select alteast one file...", "B'Zer - Calcutta High Court", MessageBoxButtons.OK, MessageBoxIcon.Error);
                                listView1.Focus();
                                return;
                            }
                        }
                        ...
                        {
                            MessageBox.Show("You must add alteast one file...", "B'Zer - Calcutta High Court", MessageBoxButtons.OK, MessageBoxIcon.Error);
                            deTextBox1.Focus();
                            return;
                        }
                    }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (listView1.Items.Count > 0)
            {
                ...
                DialogResult result = MessageBox.Show("Do you want to save changes ? ", "B'Zer - Calcutta High Court - Confirmation !", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            ...
            {
                MessageBox.Show("Please add atleast one file for Bundle No : "+textBox2.Text,"B'Zer - Calcutta High Court",MessageBoxButtons.OK,MessageBoxIcon.Warning);
                deTextBox1.Focus();
                return;
            }
        }
