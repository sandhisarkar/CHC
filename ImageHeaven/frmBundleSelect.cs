...
namespace ImageHeaven
{
    public partial class frmBundleSelect : Form
    {
        ...
        public frmBundleSelect(eSTATES[] prmState, OdbcConnection prmCon,OdbcTransaction pTxn, Credentials prmCrd)
		{
			...
			InitializeComponent();
            sqlCon = prmCon;
			this.Text = "B'Zer - Calcutta High Court - Fetch Docket";
			state=prmState;
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            if (state[0] == eSTATES.METADATA_ENTRY)
            {
                ...
                {
                    MessageBox.Show(this, "Please select Project and proper Bundle from the dropdown", "B'Zer - Calcutta High Court - Selection Error !", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
            }
            if (state[0] == eSTATES.BARCODE_ENTRY)
