    ...
    public partial class frmBundleSummary : Form
    {
        ...
        private void dtGrdVol_DoubleClick(object sender, EventArgs e)
        {
            ...
            if (_GetBundleStatus(Convert.ToString(projKey), Convert.ToString(bundleKey)).Rows[0][0].ToString() == "0")
            {
                ...
                {
                    MessageBox.Show("Metadata already added for this Bundle...", "B'Zer - Calcutta High Court", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    deTextBox1.Focus();
                    return;
                }
            }
            ...
            {
                MessageBox.Show("This Bundle have already uploaded...", "B'Zer - Calcutta High Court", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                deTextBox1.Focus();
                return;
            }
